...
llm = HelloAgentsLLM()
agent = SimpleAgent(name="只是助手", llm=llm)
...
result1 = rag_tool.execute("add_text", 
                           text="Python是一种高级编程语言,由Guido van Rossum 于1991年首次发布.Python的设计哲学强调代码的可读性和简介的语法",
...
print("\n ==== 搜索知识 ====")
result = rag_tool.execute("search", query="Python编程语言的历史", limit=3, min_score=0.1)
print(result)
